	...
	return (
		<Card className="border border-slate-200 shadow-sm p-8 text-center">
			<Card.Content className="items-center">
				...
				<h2 className="text-2xl font-semibold text-slate-900 mb-2">Otros equipos section</h2>
				<p className="text-slate-500 max-w-2xl">
					Otros equipos está registrado en el navbar y su vista detallada aún no está implementada.
				</p>
			</Card.Content>
		</Card>
	);
